...
# puts "Trả về chuỗi có ký tự đầu tiền viết hoa:"
# puts myString.capitalize
...
# puts "Trả về một chuỗi có các ký tự hoán đổi(hoa->thường,thường->hoa)"
# puts myString.swapcase
...
# puts "Thêm các khoảng trắng bên trái count ký tự:"
# p myString.ljust(10)
# puts myString.rjust(3,"!")
...
# puts myString.concat("hello ")


# p [1..10].any?(1)

# upcase,dowcase,center,ljust,rjust,lstrip,rstrip,strip,chop,concat,slice,chomp,chars


#cac cach so sanh chuoi
puts "k"=="k"
puts "k".eql?("k")
